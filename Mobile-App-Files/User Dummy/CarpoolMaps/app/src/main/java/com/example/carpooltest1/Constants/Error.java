...
public class Error {
    ...
    public static final int NO_DRIVER_FOUND = 40412;
    public static final int CRITICALSECTION_ERROR = 40413;
    ...
    public static final  String URL_LOGIN = URL_MAIN + "userloginuser.php";
    ...
    public static final  String URL_USERREQUESTGET_USER = URL_MAIN + "getUserRequests_user.php";
