...
import static com.example.carpooltest1.Constants.Error.URL_USERREQUESTGET_USER;
import static com.example.carpooltest1.Constants.Error.User_Canceled_ride_User_driver_reviews_not_given;
...
//                statusupdate(User_Canceled_ride_User_driver_reviews_not_given,0);
//            }
//        });
...
//            @Override
//            public void onClick(View v) {
//                statusupdate(User_Canceled_ride_User_driver_reviews_not_given,1);
//            }
//        });
...
//            @Override
//            public void onClick(View v) {
//                statusupdate(User_Canceled_ride_User_driver_reviews_not_given,2);
//            }
//        });
...
//            @Override
//            public void onClick(View v) {
//                statusupdate(User_Canceled_ride_User_driver_reviews_not_given,3);
//            }
//        });
//
...
//            }
//        });
        Driver_ID = getView().findViewById(R.id.PFrag_Driver_ID_txt);
        progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading");
        User_Cancel = getView().findViewById(R.id.PFrag_Cancel);

        User_Cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                statusupdate(User_Canceled_ride_User_driver_reviews_not_given);
            }
        });
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_USERREQUESTGET_USER,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i= 0;i < jsonArray.length();i++){
                                ...
                                Log.d(TAG, "onResponse: " + jsonObject.getString("UserID"));
                                try{
                                ...
                                if(Integer.parseInt(jsonObject.getString("Status")) == Ride_Started){
                                    Ride[i] = true;
                                    Log.d(TAG, "onResponse: Ride Started for " + i);
                                }
                                else{
                                    Ride[i] = false;
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("UserID", SharedPrefManager.getInstance(getActivity()).getUsername());
                return params;
            }
        };
    ...
    private void statusupdate(final int Status){
        ...
        final StringRequest string_request_insert_review = new StringRequest(Request.Method.POST, URL_END_RIDE,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("UserID", SharedPrefManager.getInstance(getContext()).getUsername());
                return params;
            }
        };
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("Message") == String.valueOf(STATUS_UPDATE_FAILED)){
                                ...
                                if (Status == User_Canceled_ride_User_driver_reviews_not_given) {
    ...
    private void update_views() {
        for (int i = 0; i < 4; i++) {
            if (UserIDs[i] != null) {
                if (Ride[i]) {
                    userlist[i].setText(userlist[i].getText() + "- Ride Started");
...
////                    Src.setText(place.getName());
        ...
        Driver_ID.setText("Driver: :" + DriverID);
        Driver_ID.setVisibility(View.VISIBLE);

        for(int i =0;i<UserIDs.length;i++){
            if(UserIDs[i]!=null){
                userlist[i].setVisibility(View.VISIBLE);
